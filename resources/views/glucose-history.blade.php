    ...
    <main class="flex-grow pt-32 pb-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Total Patients Card -->
                <div
                    class="glass-panel rounded-2xl p-6 shadow-sm relative overflow-hidden group hover:shadow-md transition">
                    <div
                        class="absolute top-0 right-0 w-32 h-32 bg-sky-100 rounded-full mix-blend-multiply filter blur-2xl opacity-50 transform translate-x-10 -translate-y-10">
                    </div>
                ...
                <div
                    class="glass-panel rounded-2xl p-6 shadow-sm relative overflow-hidden group hover:shadow-md transition">
                    <div
                        class="absolute top-0 right-0 w-32 h-32 bg-blue-100 rounded-full mix-blend-multiply filter blur-2xl opacity-50 transform translate-x-10 -translate-y-10">
                    </div>
            ...
            <div class="glass-panel rounded-3xl shadow-lg border border-white/50 overflow-hidden">
                <div
                    class="p-6 border-b border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-4 bg-white/50">
                            ...
                            @forelse($histories as $history)
                                <tr class="hover:bg-blue-50/50 transition duration-150">
                                    <td class="px-6 py-4 font-medium text-slate-900">
                                        #{{ $histories->firstItem() + $loop->index }}</td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                            <span
                                                class="font-medium text-slate-800">{{ $history->created_at->format('M d, Y') }}</span>
                                            <span
                                                class="text-xs text-slate-400">{{ $history->created_at->format('h:i A') }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span
